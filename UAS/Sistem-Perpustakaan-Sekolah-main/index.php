...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="assets\logo smart.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm justify-space-between">
  <div class="container-fluid">
    <img src="assets\logo smart.png" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Smart</span>Library</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">SmartLibrary</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      ...
      <div class="d-flex justify-content-center">
        <h3 class="text-secondary">Created by :</h3>
      </div>

    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Movida Tantra Putra Malani (22090137)</div>
        <div class="card-header">Siti Khodijah (22090073)</div>
        <div class="card-header">Syeli Mutiatul Hilmy (22090048)</div>
        <div class="card-header">Zielda Okkya Lorosae (22090054)</div>
        <div class="card-body">
          <h5 class="card-title">D4 TEKNIK INFORMATIKA POLITEKNIK HARAPAN BERSAMA</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets\logo smart.png" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Politeknik Harapan Bersama Kota Tegal</h3>
          <p class="text-secondary fs-6">Jl. Mataram No.9, Pesurungan Lor, Kec. Margadana, Kota Tegal, Jawa Tengah 52147</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Created by :  <a href="" class="text-decoration-none">Movida , Khodijah , Syeli , Zielda</a>  2024</p>
        </div>
      </div>
    </footer>
